...
const Skills = () => {
  ...
  return (
    <main className="grid w-full min-h-screen text-gray-100 bg-white place-content-center">
        ...
        <div className="flex items-center justify-center">
          <svg className="transform -rotate-90 w-72 h-72">
            ...
            <circle
              ...
              strokeDashoffset={(2 * Math.PI * 120 * (100 - parseInt(currentSkill.percent))) / 100}
